...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\USER\Desktop\geekbrains\python123\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\USER\Desktop\geekbrains\python123\venv\Scripts\deactivate.nu'
